		...
		<div class="container">
			...
			<div id="content" class="span-24 ">
				...
				<article class="span-20 prepend-3" id="firstrow">
					<section id="" class="colborder border column span-7">
					...
					<section id="" class="colborder column span-7">
					...
					<section id="" class="colborder column last">
				...
				<article class="span-20 prepend-3" id="secondrow">
					<section id="" class="colborder column span-7">
						<h3>Recently Updated R&eacute;sum&eacute;s:</h3>
						<ul>
							<?php //recentChanges(); ?>
							<li>LIST ONE</li>
							<li>LIST TWO</li>
